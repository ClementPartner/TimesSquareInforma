...
<div id="interface">
	...
	<div class="box-geral">
		<div class="w3-responsive w3-center w3-text-white"
				style="background-color: black; padding: 0 10px; height: 320px; width: 600px;">

			<p> </p>

			<input type="hidden" name="txtDiretorio" id="idDiretorio"
				value="<?= $dir; ?>">				
	...
	<a id="idDeletar" href="#" class="glyphicon glyphicon-trash botao-lixo w3-ripple"
		onclick="Confirmacao()" role="button"></a>
	...
	<script src="../../_funcoes/_javascript/funcoes-deletar-upload.js"></script>
